...
@section('main-container')
        ...
        <section class="breadcrumb-area">
            <div class="container">
                <div class="breadcrumb-content" data-aos="fade-up">
                    ...
                    <h1 class="section-heading"><img src="{{url('frontend/images/star-2.png')}}" alt="Star"> Aesthetic design for brand <br>new startup <img src="{{url('frontend/images/star-2.png')}}" alt="Star"></h1>
                </div>
            </div>
        </section>
        ...
        <section class="project-details-wrap">
            <div class="project-details-img" data-aos="zoom-in">
                <img src="{{url('frontend/images/project-dt-1.jpg')}}" alt="Project Details">
            </div>
            ...
            <div class="container">
                <div data-aos="zoom-in">
                    <div class="d-flex project-infos-wrap shadow-box mb-24">
                        ...
                        <img src="{{url('frontend/images/icon2.png')}}" alt="Icon">
                ...
                <div class="project-details-2-img mb-24" data-aos="zoom-in">
                    <img src="{{url('frontend/images/project-dt-1.jpg')}}" alt="Project">
                </div>
                ...
                <div data-aos="zoom-in">
                    <div class="project-about-2 d-flex shadow-box mb-24">
                        ...
                        <div class="left-details">
                            <img src="{{url('frontend/images/icon3.png')}}" alt="Icon">
                            <ul>
                                <li>
                                    <p>Year</p>
                                    <h4>2023</h4>
