        ...
        <section class="breadcrumb-area">
            <div class="container">
                <div class="breadcrumb-content" data-aos="fade-up">
                    ...
                    <h1 class="section-heading"><img src="{{url('frontend/images/star-2.png')}}" alt="Star"> Blog Details <img src="{{url('frontend/images/star-2.png')}}" alt="Star"></h1>
                </div>
            </div>
        </section>
                                    ...
                                    <div class="comments">
                                        ...
                                        <div class="comment-list">
                                            <div class="comment-avatar">
                                                <img src="{{url('frontend/images/comment.png')}}" alt="Avatar">
                                            </div>
